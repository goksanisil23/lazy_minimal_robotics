...
const std::string CAM_POSE_TXT_PATH = "../../resources/data/cam_pose_gt.txt";
...
void setTextureForSculpture(cc::World &world)
{
    ...
    world.ApplyColorTextureToObject("Sculpture_StaticMesh2_33", carla::rpc::MaterialParameter::Tex_Diffuse, carla_texture);
}
...
int main()
{
    try
    {
        ...
        while (true)
        {
            ...
            cam_pose_out_txt << ii << " " << camera_pose_robotics.x << " " << camera_pose_robotics.y << " " << camera_pose_robotics.z
                             << " " << camera_pose_robotics.qx << " " << camera_pose_robotics.qy << " " << camera_pose_robotics.qz << " " << camera_pose_robotics.qw << "\n";
